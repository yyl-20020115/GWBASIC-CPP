...
#define ioResult ioresult
	...
	size_t pio_input_string(text_descriptor* td, char* buf, size_t len, int padding);
...
public:
	friend class text& operator << (class text& t, format_integer const& fi) {
...
public:
	friend class text& operator << (class text& t, format_unsigned const& fi) {
...
public:
	friend class text& operator << (class text& t, format_long const& fi) {
...
public:
	friend class text& operator << (class text& t, format_ulong const& fi) {
...
public:
	friend class text& operator << (class text& t, format_lpsz const& fs) {
...
public:
	friend class text& operator << (class text& t, format_char const& fc) {
